...
fig_hist_timePeriod <- ggplot(occ_timePeriod, aes(x=timePeriod, y=n, fill=timePeriod))    + geom_bar(stat="identity", position=position_dodge(), fill="#883107", alpha=0.9) +
...
ggsave(fig_hist_timePeriod, filename = "figs/fig_histCountBytimePeriod.png", width=12, height=7,device = png(), units="in", dpi = 300); dev.off()

## We observed that the majority of historical specimens/observations are from the time period 1850 - 1900. 
```
...
ggsave(fig_loc_timePeriod, filename = "figs/fig_histCount_loc_timePeriod.png", width=12, height=7,device = png(), units="in", dpi = 300); dev.off()
...
ggsave(fig_spp_timePeriod, filename = "figs/fig_hsitSpp_timePeriod.png", width=50, height=20, device = png(), units="in", dpi = 300, limitsize = F); dev.off()
...
ggsave(fig_spp_loc_timePeriod, filename = "figs/fig_histSpp_loc_timePeriod_min10.png", width=15, height=10,device = png(), units="in", dpi = 300); dev.off()
```
...
fig_modSpp_loc <- ggplot(modOcc_spp, aes(x=historical_site_code, y=n, fill=historical_site_code)) + geom_bar(stat="identity", position=position_dodge(), fill="#883107", alpha=0.9) +
  geom_text(aes(label=n, hjust="middle", vjust=-0.5), 
            position = position_dodge(), angle=0, size=5) +
...
ggsave(fig_modSpp_loc, filename = "figs/fig_modSpp_loc.png", width=40, height=10, device = png(), units="in", dpi = 300); dev.off()
