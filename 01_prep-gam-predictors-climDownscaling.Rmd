...
```{r}
clim_files <- list.files("data/climate/historical", full.names = T)
...
```{r}
# make coast raster
# the below lines of code take a very long time to run
...
lat_raster <- data.table::copy(elev_600)
