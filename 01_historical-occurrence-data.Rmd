...
ggsave(fig_loc_timePeriod, filename = "figs/fig_specimenCount_locality_timePeriod.png", width=12, height=7,device = png(), units="in", dpi = 300); dev.off()
...
ggsave(fig_spp_timePeriod, filename = "figs/fig_species_timePeriod.png", width=50, height=20, device = png(), units="in", dpi = 300, limitsize = F); dev.off()
...
ggsave(fig_spp_loc_timePeriod, filename = "figs/fig_species_loc_timePeriod_min10.png", width=15, height=10,device = png(), units="in", dpi = 300); dev.off()
```
