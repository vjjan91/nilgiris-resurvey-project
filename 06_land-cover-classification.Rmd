...
## force set extents
ext(rast2018) <- c(660555.3, 719133.3, 1240050, 1277598)
...
f) What are areas that haven't changed at all over time? (1= 1, 2= 2 and so on)

g) Still need to run an actual change detection analysis

h) Elevational change in grassland habitat over time - like visualizae a 3d topographic model of the landscape and how grassland habitats have shifted or changed over time?

i) Overlap elevation DEM over the Ouchterlony map to provide readers a sense of accuracy/correctness of the map? (Separate couple of hours to extract relevant information from archival sources about Ouchterlony & the map). 
