...
nil1848 <- rbind(
  ag1848, plantations1848, settlements1848,
...
png(
  filename = "figs/fig_landCover_1848_vs_2018.png",
...
png(
  filename = "figs/fig_landCover_1848_vs_2018reclassified.png",
  width = 12, height = 7, units = "in", res = 300
)
...
fig_area <- ggplot(areaCalc, aes(
  ...
  scale_fill_manual(values = c(
    "#be4fc4", "#d73027", "#b0a69d",
    "#025a05", "#cbb315", "#04a310",
    "#c17111", "#2035df"
  )) +
  geom_text(
    aes(
      label = round(Area), hjust = "middle",
      vjust = -0.5
    ),
...
## saving a high resolution visualization
png(
  filename = "figs/fig_landCover_2018_vs_2017.png",
  width = 12, height = 7, units = "in", res = 300
)

par(mfrow = c(1, 2))
plot(rast2018,
  col = colors2018, main = "2018 Sentinel classification",
  legend = FALSE
)
