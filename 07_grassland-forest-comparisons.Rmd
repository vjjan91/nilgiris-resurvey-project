...
png(
  filename = "figs/fig_forests_1848_vs_2018.png",
...
## saving a high resolution visualization
png(
  filename = "figs/fig_grasslands_1848_vs_2018.png",
  width = 12, height = 7, units = "in", res = 300
)
...
for2018 <- mapview(vect2018[vect2018$name == "shola_forest", ],
  col.regions = "#04a310",
  alpha.regions = 0.5
)
...
vect1848poly <- cbind(
  vect1848poly, elevMin[, -1],
  elevMean[, -1], elevMax[, -1]
)
names(vect1848poly) <- c(
  "name", "year", "elevMin",
...
vect2018poly <- cbind(
  vect2018poly, elevMin[, -1],
  elevMean[, -1], elevMax[, -1]
)
names(vect2018poly) <- c(
  "name", "year", "elevMin",
  "elevMean", "elevMax", "geometry"
)
