...
We subset the data for the decades between 1970 and 2010 for which reliable comparative spatial climate datasets are available from remote sensing.
...
First, we obtained bio-climatic data from CHELSA. We do not upload the rasters to GitHub as they are very large in size and these can be downloaded from this [link](https://chelsa-climate.org/bioclim/).  
