...
```{r}
## This analysis is being done at the community-level
...
ggsave(fig_relAbun_over_time, filename = "figs/fig_relAbun_communityLevel.png", width = 15, height = 10, device = png(), units = "in", dpi = 300)
```
...
Takeaways: No clear differences in relative abundances over time seen at the landscape level and site-level. Due to incomplete sampling, there are some sites that show a relatively higher abundance in earlier time periods when compared to modern occurrence. 
