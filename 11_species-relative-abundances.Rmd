...
# remove localities with limited amount of data
...
# regressing 1900-1950 data vs. 2021
fig_1900v2021_rel <- ggplot(data=relAbun,aes(x=`2021`,y=`1900-1950`)) +
   scale_y_log10() +
  geom_abline(slope=1, intercept=0,linetype="dashed") +
  scale_x_log10() +
  ...
  stat_regline_equation(aes(label = ..rr.label..)) +
  theme_bw() +
  theme(axis.text = element_text(family = "Century Gothic", 
                                 size = 13),
        legend.title = element_text(family = "Century Gothic"),
    legend.text = element_text(family = "Century Gothic"),
    text = element_text(family = "Century Gothic", size = 25))

ggsave(fig_1900v2021_rel, filename = "figs/fig_1900-1950vs2021_relAbun.png", width = 15, height = 10, device = png(), units = "in", dpi = 300)
dev.off()

# regressing 1850-1900 data against 1900-1950 data
fig_1850v1900_rel <- ggplot(data=relAbun,aes(x=`1900-1950`,y=`1850-1900`)) +
   scale_y_log10() +
  geom_abline(slope=1, intercept=0,linetype="dashed") +
  scale_x_log10() +
  labs(y = "1850-1900 Relative abundance", 
       x = "1900-1950 Relative abundance") +
   geom_point(shape = 21, colour = "black", fill = "white", size = 2, stroke = 1)+
   geom_smooth(method="lm", se=TRUE, fullrange=FALSE, level=0.95,linetype="solid")+
  stat_regline_equation(aes(label = ..rr.label..)) +
  theme_bw() +
...
ggsave(fig_1850v1900_rel, filename = "figs/fig_1850-1900vs1900-1950_relAbun.png", width = 15, height = 10, device = png(), units = "in", dpi = 300)
dev.off()
```
