...
report::report(glmm_habType)

# We fitted a linear mixed model (estimated using REML and nloptwrap optimizer) to predict PXt with Habitat.type (formula: PXt ~ Habitat.type). The model included scientific_name and historical_site_code as random effects (formula: list(~1 | scientific_name, ~1 | historical_site_code)). The model's total explanatory power is substantial (conditional R2 = 0.28) and the part related to the fixed effects alone (marginal R2) is of 5.61e-03. The model's intercept, corresponding to Habitat.type = Forest, is at 0.85 (95% CI [0.82, 0.88], t(75419) = 60.14, p < .001). Within this model:

#  - The effect of Habitat type [Generalist] is statistically non-significant and positive (beta = 5.94e-03, 95% CI [-0.02, 0.03], t(75419) = 0.50, p = 0.614; Std. beta = 0.04, 95% CI [-0.12, 0.20])
#  - The effect of Habitat type [Grassland] is statistically significant and negative (beta = -0.04, 95% CI [-0.06, -8.80e-03], t(75419) = -2.59, p = 0.010; Std. beta = -0.24, 95% CI [-0.43, -0.06])
#  - The effect of Habitat type [Wooded Habitat] is statistically non-significant and negative (beta = -2.70e-03, 95% CI [-0.02, 0.02], t(75419) = -0.25, p = 0.800; Std. beta = -0.02, 95% CI [-0.16, 0.12])
...
report::report(glmm_bodyMass)

# We fitted a linear mixed model (estimated using REML and nloptwrap optimizer) to predict PXt with weight_z (formula: PXt ~ weight_z). The model included scientific_name and historical_site_code as random effects (formula: list(~1 | scientific_name, ~1 | historical_site_code)). The model's total explanatory power is substantial (conditional R2 = 0.28) and the part related to the fixed effects alone (marginal R2) is of 4.05e-03. The model's intercept, corresponding to weight_z = 0, is at 0.85 (95% CI [0.82, 0.87], t(75421) = 70.98, p < .001). Within this model:

#  - The effect of weight z is statistically significant and negative (beta = -9.82e-03, 95% CI [-0.02, -2.89e-03], t(75421) = -2.78, p = 0.005; Std. beta = -0.07, 95% CI [-0.11, -0.02])
...
report::report(glmm_hwi)

# We fitted a linear mixed model (estimated using REML and nloptwrap optimizer) to predict PXt with hand_wing_index_z (formula: PXt ~ hand_wing_index_z). The model included scientific_name and historical_site_code as random effects (formula: list(~1 | scientific_name, ~1 | historical_site_code)). The model's total explanatory power is substantial (conditional R2 = 0.28) and the part related to the fixed effects alone (marginal R2) is of 2.34e-03. The model's intercept, corresponding to hand_wing_index_z = 0, is at 0.85 (95% CI [0.83, 0.87], t(75421) = 70.66, p < .001). Within this model:

#  - The effect of hand wing index z is statistically significant and negative (beta = -7.46e-03, 95% CI [-0.01, -6.36e-04], t(75421) = -2.14, p = 0.032; Std. beta = -0.05, 95% CI [-0.10, -4.32e-03])
