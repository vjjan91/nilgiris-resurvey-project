...
fig_rankAbund <- ggplot(rank_abund_dat, aes(x = scientific_name, y = rel_abund, fill = rel_abund)) +
...
Data: relSpAbund
 ...
 -3522.7  -3493.9   1767.3  -3534.7      880 

Random effects:

Conditional model:
 Groups          Name        Variance Std.Dev.
 site            (Intercept) 0.1749   0.4182  
 scientific_name (Intercept) 0.1333   0.3651  
Number of obs: 886, groups:  site, 28; scientific_name, 68

Dispersion parameter for beta family (): 27.9 

Conditional model:
            Estimate Std. Error z value Pr(>|z|)    
(Intercept)  -2.3003     0.1281  -17.96  < 2e-16 ***
year2021     -0.8554     0.1141   -7.50 6.39e-14 ***

Zero-inflation model:
            Estimate Std. Error z value Pr(>|z|)
(Intercept)    -22.4     2455.3  -0.009    0.993
...
(marginal R2) is of 0.14. The model's intercept, corresponding to year =
1850, is at -2.30 (95% CI [-2.55, -2.05], p < .001). Within this model:

  - The effect of year [2021] is statistically significant and negative (beta
= -0.86, 95% CI [-1.08, -0.63], p < .001; Std. beta = -0.86, 95% CI [-1.08,
-0.63])
