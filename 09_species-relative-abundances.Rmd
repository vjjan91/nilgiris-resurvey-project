...
```{r}
## overall
glmm_overall <- glmer(relAbundance ~ year + (1|historical_site_code) +(1|scientific_name),
                      data = relSpAbund, family = gaussian(link="identity"))

summary(glmm_overall)
tukey_glmm_overall <- summary(glht(glmm_overall, linfct=mcp(year ="Tukey")))
cld(tukey_glmm_overall) # significant diff between each time period
report::report(glmm_overall)

# We fitted a linear mixed model (estimated using REML and nloptwrap optimizer) to predict relAbundance with year (formula: relAbundance ~ year). The model included historical_site_code and scientific_name as random effects (formula: list(~1 | historical_site_code, ~1 | scientific_name)). The model's total explanatory power is substantial (conditional R2 = 0.28) and the part related to the fixed effects alone (marginal R2) is of 0.10. The model's intercept, corresponding to year = 1850, is at 0.06 (95% CI [0.05, 0.07], t(1432) = 9.65, p < .001). Within this model:

#  - The effect of year [1900] is statistically significant and positive (beta = 0.03, 95% CI [0.02, 0.04], t(1432) = 5.07, p < .001; Std. beta = 0.44, 95% CI [0.27, 0.61])
#  - The effect of year [2021] is statistically significant and negative (beta = -0.03, 95% CI [-0.04, -0.02], t(1432) = -5.51, p < .001; Std. beta = -0.42, 95% CI [-0.57, -0.27])
...
glmm_forest <- glmer(relAbundance ~ year +(1|historical_site_code) + (1|scientific_name), data = forest_glmm, family = gaussian(link="identity"))
...
# We fitted a linear mixed model (estimated using REML and nloptwrap optimizer) to predict relAbundance with year (formula: relAbundance ~ year). The model included historical_site_code and scientific_name as random effects (formula: list(~1 | historical_site_code, ~1 | scientific_name)). The model's total explanatory power is substantial (conditional R2 = 0.62) and the part related to the fixed effects alone (marginal R2) is of 0.30. The model's intercept, corresponding to year = 1850, is at 0.05 (95% CI [0.04, 0.06], t(555) = 10.81, p < .001). Within this model:

#  - The effect of year [1900] is statistically significant and positive (beta = 0.02, 95% CI [9.90e-03, 0.02], t(555) = 5.29, p < .001; Std. beta = 0.51, 95% CI [0.32, 0.70])
#  - The effect of year [2021] is statistically significant and negative (beta = -0.03, 95% CI [-0.03, -0.02], t(555) = -10.42, p < .001; Std. beta = -0.94, 95% CI [-1.12, -0.76])
...
glmm_grassland <- glmer(relAbundance ~ year + (1|historical_site_code) + (1|scientific_name), data = grassland_glmm, family = gaussian(link="identity"))
...
# We fitted a linear mixed model (estimated using REML and nloptwrap optimizer) to predict relAbundance with year (formula: relAbundance ~ year). The model included historical_site_code and scientific_name as random effects (formula: list(~1 | historical_site_code, ~1 | scientific_name)). The model's total explanatory power is substantial (conditional R2 = 0.60) and the part related to the fixed effects alone (marginal R2) is of 0.09. The model's intercept, corresponding to year = 1850, is at 0.12 (95% CI [0.06, 0.19], t(155) = 3.88, p < .001). Within this model:

#  - The effect of year [1900] is statistically non-significant and positive (beta = 4.73e-03, 95% CI [-0.04, 0.05], t(155) = 0.19, p = 0.848; Std. beta = 0.04, 95% CI [-0.35, 0.42])
#  - The effect of year [2021] is statistically significant and negative (beta = -0.11, 95% CI [-0.17, -0.04], t(155) = -3.42, p < .001; Std. beta = -0.83, 95% CI [-1.30, -0.35])
...
glmm_wooded <- glmer(relAbundance ~ year + (1|historical_site_code) + (1|scientific_name), data = wooded_glmm, family = gaussian(link="identity"))
...
# We fitted a linear mixed model (estimated using REML and nloptwrap optimizer) to predict relAbundance with year (formula: relAbundance ~ year). The model included historical_site_code and scientific_name as random effects (formula: list(~1 | historical_site_code, ~1 | scientific_name)). The model's total explanatory power is substantial (conditional R2 = 0.39) and the part related to the fixed effects alone (marginal R2) is of 0.10. The model's intercept, corresponding to year = 1850, is at 0.05 (95% CI [0.04, 0.06], t(992) = 7.07, p < .001). Within this model:

#  - The effect of year [1900] is statistically significant and positive (beta = 0.03, 95% CI [0.02, 0.04], t(992) = 4.65, p < .001; Std. beta = 0.46, 95% CI [0.27, 0.66])
#  - The effect of year [2021] is statistically significant and negative (beta = -0.02, 95% CI [-0.03, -0.01], t(992) = -4.74, p < .001; Std. beta = -0.42, 95% CI [-0.59, -0.24])
...
glmm_generalist <- glmer(relAbundance ~ year + (1|historical_site_code) + (1|scientific_name), data = generalist_glmm, family = gaussian(link="identity"))
...
# We fitted a linear mixed model (estimated using REML and nloptwrap optimizer) to predict relAbundance with year (formula: relAbundance ~ year). The model included historical_site_code and scientific_name as random effects (formula: list(~1 | historical_site_code, ~1 | scientific_name)). The model's total explanatory power is substantial (conditional R2 = 0.62) and the part related to the fixed effects alone (marginal R2) is of 0.06. The model's intercept, corresponding to year = 1850, is at 0.04 (95% CI [0.02, 0.05], t(751) = 4.69, p < .001). Within this model:

#  - The effect of year [1900] is statistically significant and positive (beta = 0.04, 95% CI [0.03, 0.05], t(751) = 7.47, p < .001; Std. beta = 0.77, 95% CI [0.57, 0.97])
#  - The effect of year [2021] is statistically non-significant and positive (beta = 1.29e-03, 95% CI [-7.28e-03, 9.87e-03], t(751) = 0.30, p = 0.767; Std. beta = 0.03, 95% CI [-0.15, 0.21])
