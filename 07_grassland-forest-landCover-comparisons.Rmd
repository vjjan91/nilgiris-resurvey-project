...
alt <- rast("data/spatial/elevation/alt") # this layer is not added to github as a result of its large size and can be downloaded from SRTM (Farr et al. (2007))
...
e)  add elevation and then split where forests have expanded by elevation? (ie. forest cover in 1848 and elevation in the background) and then (forest cover in 2018 and elevation in the background)