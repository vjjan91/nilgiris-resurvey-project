...
pca_plot_1850 <- ggplot(dcc_1850, aes(x = Var1, y = Var2)) +
  ...
  # points for species
  geom_point(data = Y1850, aes(x = Comp.1, y = Comp.2), size = 0.3, alpha = 0.5, colour = "grey20") +
  # add arrows
  ...
  theme(axis.text = element_text(family = "Century Gothic", size = 13),
    ...
    text = element_text(family = "CenturyGothic", size = 25)) + 
    guides(size= "none",
           fill = "none")
...
# plot 1900
pca_plot_1900 <- ggplot(dcc_1900, aes(x = Var1, y = Var2)) +
  # coloured probabilty background
  geom_raster(aes(fill = value)) +
  scale_fill_scico(palette = "lajolla")+
  # points for species
  geom_point(data = Y1900, aes(x = Comp.1, y = Comp.2), size = 0.3, alpha = 0.5, colour = "grey20") +
  # add arrows
  geom_segment(data = loadings_sc, aes(x = 0, y = 0, xend = Comp.1, yend = Comp.2), arrow = arrow(length = unit(0.2, "cm")), colour = "black") +
  # probability kernels
  geom_contour(aes(z = value), breaks = cl_50_1900, colour = "grey30", size = 1) +
  geom_contour(aes(z = value), breaks = cl_95_1900, colour = "grey60", size = 1) +
  geom_contour(aes(z = value), breaks = cl_99_1900, colour = "grey70", size = 1) +
  coord_equal() +
  # add arrows
  geom_segment(data = loadings_sc, aes(x = 0, y = 0, xend = Comp.1, yend = Comp.2), arrow = arrow(length = unit(0.2, "cm")), colour = "black") +
  # add dashed arrows ends
...
ggsave(pca_plot_1900, filename = "figs/fig_pcaPlot_1900.png", width = 15, height = 10, device = png(), units = "in", dpi = 300)

# plot 1950
pca_plot_1950 <- ggplot(dcc_1950, aes(x = Var1, y = Var2)) +
  # coloured probabilty background
  geom_raster(aes(fill = value)) +
  scale_fill_scico(palette = "lajolla")+
  # points for species
  geom_point(data = Y1950, aes(x = Comp.1, y = Comp.2), size = 0.3, alpha = 0.5, colour = "grey20") +
  # add arrows
  geom_segment(data = loadings_sc, aes(x = 0, y = 0, xend = Comp.1, yend = Comp.2), arrow = arrow(length = unit(0.2, "cm")), colour = "black") +
  # probability kernels
  geom_contour(aes(z = value), breaks = cl_50_1950, colour = "grey30", size = 1) +
  geom_contour(aes(z = value), breaks = cl_95_1950, colour = "grey60", size = 1) +
  geom_contour(aes(z = value), breaks = cl_99_1950, colour = "grey70", size = 1) +
  coord_equal() +
  # add arrows
  geom_segment(data = loadings_sc, aes(x = 0, y = 0, xend = Comp.1, yend = Comp.2), arrow = arrow(length = unit(0.2, "cm")), colour = "black") +
  # add dashed arrows ends
...
ggsave(pca_plot_1950, filename = "figs/fig_pcaPlot_1950.png", width = 15, height = 10, device = png(), units = "in", dpi = 300)
...
pca_plot_2021 <- ggplot(dcc_2021, aes(x = Var1, y = Var2)) +
  ...
  scale_fill_scico(palette = "lajolla")+
  # points for species
  geom_point(data = Y2021, aes(x = Comp.1, y = Comp.2), size = 0.3, alpha = 0.5, colour = "grey20") +
  # add arrows
  geom_segment(data = loadings_sc, aes(x = 0, y = 0, xend = Comp.1, yend = Comp.2), arrow = arrow(length = unit(0.2, "cm")), colour = "black") +
  # probability kernels
