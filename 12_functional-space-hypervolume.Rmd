...
saveRDS(Y1850_hyper_mi, "results/1850-hyperVolume-mi9.rds")

set.seed(3)
Y2021_hyper_mi <- hypervolume::hypervolume_svm(Y2021A, name = "2021")
saveRDS(Y2021_hyper_mi, "results/2021-hyperVolume-mi9.rds")

# you can load the above save .rds files using readRDS
