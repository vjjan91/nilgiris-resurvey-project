...
saveRDS(Y2021_hyper_mi, "2021_hyper_mi9.rds")
```
...
load sites data
load spec_pers_prob data (site and species level)
load species trait data

load hist and modern occurrence data - create 1s and 0s for each time period 1850, 1900, 1950 and 2021

then create a dataframe similar to Gomez et al - final tablos one to run the required  analysis with one column each for 1900...
