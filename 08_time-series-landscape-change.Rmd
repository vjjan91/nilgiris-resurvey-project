...
```{r}
rast1848 <- terra::rast("results/processed-rasters/1848.tif")
rast2018 <- terra::rast("results/processed-rasters/2018.tif")
```

## Loading data from the 1910 map
```{r}
# list all shapefiles in the directory
nil1910 <- list.files("data/spatial/1910-nilgiris/", full.names = T, recursive = T, pattern=".shp$")
...
rast2018 <- terra::rast("results/processed-rasters/2018reclassified.tif")
rast2018 <- resample(rast2018, rast1973, method = "near")

# read reclassification matrix
reclassification_matrix <- read.csv("data/spatial/1973-nilgiris/reclassification-matrix.csv")
...
a)  add 1910 map also add 1973, 1995

b)  identify multiple specific locations/areas/quadrants that can be compared over time (divide area into four)

c)  create a ggplot time series map - to show increase of forests?

d)  create ggplot time series map to show decrease of grasslands? (similar to above)



More ideas from Laurel:
