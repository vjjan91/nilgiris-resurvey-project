...
```{r}
# rasterize
# the scale of Landsat MSS is at 60 m
vect1973 <- terra::vect(nil1973)
emptyRast <- terra::rast(res = 60, xmin = 517079.8, xmax = 794369.8, ymin = 922564.6, ymax = 1500035, crs = "+proj=utm +zone=43 +datum=WGS84 +units=m +no_defs")
