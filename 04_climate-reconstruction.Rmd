...
This script is identical to previous scripts except that we shall run only a single model per season and climate variable, but for multiple time chunks, of about 30 years.
...
## Split data by variable, season, and year bin
