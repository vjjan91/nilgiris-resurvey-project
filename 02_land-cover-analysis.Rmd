...
nil2017 <- st_intersection(nil2017, contourNil)
```
...
```{r}
m1 <- mapview(forest_nil1870)
m2 <- mapview(forest_kun1870, col.regions="red")

m2017 <- nil2017[nil2017$class=="Shola Forest",]
m3 <- mapview(m2017, col.regions="green")
