...
m1 <- glmmTMB(relAbunChange ~ shola_grassland + settlements + shola_forest + water_bodies + agriculture+ shola_grassland +
                (1|scientific_name),
               data = glmm_grassland)
...
forest_lc <- glmmTMB(relAbunChange ~ shola_forest + settlements + agriculture + shola_grassland +
                 (1|scientific_name),
               data = glmm_forest,
               family = gaussian())
