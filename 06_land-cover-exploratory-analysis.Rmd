...
emptyRast <- terra::rast(res = 12, xmin = 660771, xmax = 718316.3, ymin = 1240554, ymax = 1275492, crs = "+proj=utm +zone=43 +datum=WGS84 +units=m +no_defs")
...
resam1848 <- terra::resample(rastnil1848, rastnil1973, method = "near")
...
areaCalc <- purrr::reduce(list(
  areaNil1848, areaNil1973, areaNil1995, areaNil2017
